...
def test_sequence(Simulator, plt, seed, outfile):
    _test_sequence(Simulator, plt, seed, outfile, prune_passthrough=False)


def test_sequence_pruned(Simulator, plt, seed, outfile):
    _test_sequence(Simulator, plt, seed, outfile, prune_passthrough=True)
