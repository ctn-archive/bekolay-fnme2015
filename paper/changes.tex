...
%DIF DEL oldpaper.tex   Wed Nov  4 17:49:42 2015
%DIF ADD paper.tex      Wed Nov  4 17:49:17 2015
...
\begin{abstract}
  ...
  across \DIFdelbegin \DIFdel{five }\DIFdelend \DIFaddbegin \DIFadd{four }\DIFaddend different backends
...
\DIFdelbegin \subsubsection{\DIFdel{Brainstorm software (}\texttt{\DIFdel{nengo}%DIFDELCMD < \_brainstorm%%%
}%DIFAUXCMD
\DIFdel{).}}
%DIFAUXCMD
...
based partly on Neurogrid \mbox{%DIFAUXCMD
\citep{benjamin2014}
}%DIFAUXCMD
currently in development
by the Brains in Silicon lab
at Stanford University.}\footnote{\DIFdel{
  Some details available at }%DIFDELCMD < \url{http://brainstorm.stanford.edu/projects/}%%%
\DIFdel{.}}
%DIFAUXCMD
...
{\begin{tabular}{lcc}\toprule
 ...
 \DIFdelbeginFL \DIFdelFL{Brainstorm backend }%DIFDELCMD < & %%%
\DIFdelFL{Not available on PyPI }%DIFDELCMD < & %%%
\DIFdelFL{Development version, commit }\texttt{\DIFdelFL{ac3cfa708}} %DIFAUXCMD
%DIFDELCMD < \\
%DIFDELCMD <  %%%
...
{\begin{tabular}{lccc}\toprule
 ...
 \DIFdelbeginFL \DIFdelFL{Brainstorm (}\texttt{\DIFdelFL{nengo}%DIFDELCMD < \_brainstorm%%%
}%DIFAUXCMD
\DIFdelFL{) }%DIFDELCMD < & %%%
\DIFdelFL{94 (57.0\%) }%DIFDELCMD < & %%%
\DIFdelFL{15 (48.4\%) }%DIFDELCMD < & %%%
...
\begin{figure}[!ht]
\begin{center}
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=85mm]{fig1}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=178mm]{fig1}
...
\begin{figure}[!ht]
\begin{center}
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=85mm]{fig2}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=178mm]{fig2}
\DIFaddendFL \end{center}
...
\begin{figure}[!ht]
\begin{center}
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=85mm]{fig3}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=178mm]{fig3}
\DIFaddendFL \end{center}
...
\begin{figure}[!ht]
\begin{center}
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=85mm]{fig4}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=178mm]{fig4}
\DIFaddendFL \end{center}
...
\begin{figure}[!ht]
\begin{center}
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=85mm]{fig5}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=178mm]{fig5}
\DIFaddendFL \end{center}
...
\begin{figure}[!ht]
\begin{center}
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=85mm]{fig6}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=178mm]{fig6}
\DIFaddendFL \end{center}
