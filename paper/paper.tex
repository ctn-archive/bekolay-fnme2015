...
\begin{abstract}
  ...
  functional performance and speed simulating
  ...
  some backends perform differently
  or significantly faster than others.
...
on this moderately-sized model. (??? revisit with new results)
...
would be similar, though exaggerated,
in larger models run for longer amount of time.
The distilled and brainstorms backends would
